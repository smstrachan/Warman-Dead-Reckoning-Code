...
void loop() {
  ...
  // if (!moved){
    ...
    Lstepper.moveRelative(-345);
    Rstepper.moveRelative(345);
    while (Lstepper.distanceToGo() != 0 || Rstepper.distanceToGo() != 0){
      Lstepper.run();
      Rstepper.run();
    }
    ...
    Lstepper.moveRelative(860);
    Rstepper.moveRelative(860);
    while (Lstepper.distanceToGo() != 0 || Rstepper.distanceToGo() != 0){
      Lstepper.run();
      Rstepper.run();
    }
  ...
  // TODO: tune numbers for end 
    ...
    Lstepper.moveRelative(-370);
    Rstepper.moveRelative(370);
    while (Lstepper.distanceToGo() != 0 || Rstepper.distanceToGo() != 0){
      Lstepper.run();
      Rstepper.run();
    }
